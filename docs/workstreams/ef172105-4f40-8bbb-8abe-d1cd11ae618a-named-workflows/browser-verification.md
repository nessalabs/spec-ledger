...
Verified during eb02e4af-5c85-89fa-8aad-70f0444297f7 against an agent-created disposable repository served by the local UI bridge. The normal workspace was used only for viewing the builder.
