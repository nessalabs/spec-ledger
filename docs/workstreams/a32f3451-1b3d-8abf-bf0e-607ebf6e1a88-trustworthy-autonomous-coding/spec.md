...
**a32f3451-1b3d-8abf-bf0e-607ebf6e1a88 · Implementation direction · September 4, 2026**
...
```text
docs/workstreams/a32f3451-1b3d-8abf-bf0e-607ebf6e1a88-trustworthy-autonomous-coding/
  spec.md
  review-notes.md
  evidence/
    <run-id>/
...
These are the canonical draft criteria. a32f3451-1b3d-8abf-bf0e-607ebf6e1a88 JSON holds indexing metadata; do not maintain a second hand-written acceptance contract. Detailed implementation specs should reference these stable IDs.
...
Implementation uses the library-consumer trust profile and portable CLI choice recorded below. Existing seal policy, including 4f850c5a-83ce-85c9-a081-b0a3e02d2811, requires an explicit revision to admit delegated execution; this draft does not silently change it.
