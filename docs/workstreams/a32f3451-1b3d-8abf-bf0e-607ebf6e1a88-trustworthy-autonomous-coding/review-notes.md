...
| --- | --- | --- |
| All eight dogfood bindings check file existence | `.spec-ledger/bindings/e1a3fe4b-6226-83e6-984e-654abfb57689.json` through `a4db64ff-3857-8e09-ab4c-0e34627ec84b.json` | Green currently does not establish the behavior described by those claims. |
...
| Snapshot checking compares stored hash labels without hashing snapshot content | `packages/ledger/src/workstream/load.ts:130–142` | A changed snapshot body can escape this check. The human-readable Markdown is not presently included; d1be55a6-11bb-8460-8650-ddf0ecac8185 already proposes that addition. |
...
turn: (none)
workstream: a32f3451-1b3d-8abf-bf0e-607ebf6e1a88 (draft)
contextDigest: none
