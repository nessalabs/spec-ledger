...
function load(path, overrides={}) {
  ...
  new Function('require','module','exports',compiled)(id=>id in overrides?overrides[id]:(id==='@/components/readable-text'?load('../components/readable-text.tsx'):id==='@/lib/record-labels'?load('./record-labels.ts'):id==='@/lib/workstream-list'?load('./workstream-list.ts'):id==='./acceptance-progress'?load('./acceptance-progress.ts'):require(id)),module,module.exports)
