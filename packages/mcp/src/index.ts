...
const descriptions: Record<OperationName, string> = {
  create_tenet: "Record a tenet and return its generated UUID.",
  create_theme: "Create a theme and return its generated UUID.",
  record_learning: "Record an attributed learning and return its generated UUID.",
  create_workstream: "Create a draft workstream with a short title; Spec Ledger generates its UUID and slice identities. Never choose numbered IDs.",
  create_claim: "Create a live claim under an authorized open turn and return its generated UUID.",
  create_proposed_claim: "Propose a claim for a workstream and return its generated UUID.",
  create_binding: "Create a binding for an existing claim under an authorized open turn and return its generated UUID.",
